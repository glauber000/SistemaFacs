 ...
 * @author glaub
 */
public class TEAlunos extends javax.swing.JFrame {

    /**
     * Creates new form TEAlunos
     */
    public TEAlunos() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(bs.getAlunos(mat)!=null){
            bs.deletAlu(bs.getAlunos(mat));
            f.setTxt("Excluído!");
            f.setVisible(true);
        } else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TEAlunos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
