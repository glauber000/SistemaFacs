 ...
 * @author glaub
 */
public class TEProfessor extends javax.swing.JFrame {

    /**
     * Creates new form TEProfessor
     */
    public TEProfessor() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(bs.getProfessores(mat)!=null){
            bs.deletPro(bs.getProfessores(mat));
            f.setTxt("Excluído!");
            f.setVisible(true);
        } else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TEProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TEProfessor().setVisible(true);
            }
        });
    }
