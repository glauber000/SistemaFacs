 ...
 * @author glaub
 */
public class TESetor extends javax.swing.JFrame {

    /**
     * Creates new form TESetor
     */
    public TESetor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exclusão de Setores!");

        jLabel3.setText("Digite abaixo o código do setor para exclusão.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String txt = "";
        boolean tt = false;
        if(bs.getSetor(id)!= null){
            for(int i=0;i<ad.size();i++){
                if(bs.getSetor(id).getNome().equalsIgnoreCase(ad.get(i).getSetor().getNome())){
                    txt += ad.get(i).getNome() + "\n";
                    tt = true;
                }
            }
            if(tt){
                l.setLbl("Exclua os seguintes Funcionários para excluir o setor");
                l.modificar(txt);
                l.setVisible(true);
            } else{
                bs.deletSet(bs.getSetor(id));
                f.setTxt("Excluído!");
                f.setVisible(true); 
            }
        } else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TESetor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
