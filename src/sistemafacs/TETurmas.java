 ...
 * @author glaub
 */
public class TETurmas extends javax.swing.JFrame {

    /**
     * Creates new form TETurmas
     */
    public TETurmas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exclusão de Turmas!");

        jLabel3.setText("Digite abaixo o código da turma para exclusão.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(bs.getTurmas(id)!=null){
            bs.deletTur(bs.getTurmas(id));
            f.setTxt("Excluído!");
            f.setVisible(true);
        } else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TETurmas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
